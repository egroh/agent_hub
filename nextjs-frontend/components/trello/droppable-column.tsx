  ...
  return (
    <div
      ...
      className={cn(
        ...
        isOver &&
          "shadow-xl ring-4 ring-blue-300 ring-opacity-30 scale-102 border-blue-300",
    ...
    >
      ...
      <div
        className={cn(
          ...
          isOver &&
            "min-h-[220px] bg-blue-50/50 border-2 border-dashed border-blue-300",
        )}
      >
        {column.cards.map((card, index) => (
          ...
          >
            <DraggableCard card={card} onClick={() => onCardClick?.(card)} />
          </div>
        ))}
